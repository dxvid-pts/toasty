...
## [0.10.0](https://github.com/tokio-rs/toasty/compare/toasty-driver-dynamodb-v0.9.0...toasty-driver-dynamodb-v0.10.0) - 2026-08-07

### Fixed

- Resolve authority-form SQLite and Turso URLs to file paths ([#1127])
